...
Cada vez que é chamada, ela entrega o próximo elemento do iterador, exatamente como a atendente chama o próximo cliente para ser atendido após o anterior terminar.   
